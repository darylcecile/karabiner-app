...
export const colors = {
  ...
  chatBackground: semanticColor("#dbe6f6", "#161a26"),
  chatBackgroundAccent: semanticColor("#e9d8fb", "#1d1a2c"),
  chatPattern: semanticColor("rgba(120,110,180,0.10)", "rgba(140,150,200,0.10)"),
  ...
  floatingSurface: semanticColor("rgba(255,255,255,0.96)", "rgba(36,40,48,0.92)"),
  ...
  telegramPurple: semanticColor("#9b6cf2", "#a781f5"),
  systemRed: semanticColor("#ff3b30", "#ff453a"),
  incomingBubble: semanticColor("#ffffff", "rgba(40,44,52,0.98)"),
